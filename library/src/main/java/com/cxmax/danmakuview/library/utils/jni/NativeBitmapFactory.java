 ...
 *             https://github.com/Bilibili/DanmakuFlameMaster/tree/master/DanmakuFlameMaster/src/main/java/tv/cjump/jni/NativeBitmapFactory.java
 * @usage :
 * <p>
 * </p>
...
public class NativeBitmapFactory {
    ...
    public static void loadLibs() {
        ...
        if (!(DeviceAbiUtil.isRealARMArch() || DeviceAbiUtil.isRealX86Arch())) {
            notLoadAgain = true;
